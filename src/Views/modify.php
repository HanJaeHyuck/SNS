    ...
    <div class="write">
        ...
        <form method="post" action="/modify">
            ...
            <div class="form-group">
                <input type="text" class="form-control" id="title" name="title" placeholder="<?= $_SESSION['user']->name ?>의 소중한 일상" value="<?= $list->title ?>">
            </div>
            <div class="form-group">
                <textarea class="form-control" id="content" placeholder="글 내용을 입력하세요" name="content"><?= $list->content ?></textarea>
            </div>
            <div class="write-btn">
